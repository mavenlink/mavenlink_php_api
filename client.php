...
$workspaces = json_decode($brain->getWorkspaces());
...
print_r($brain->createExpenseForWorkspace(1167889, array('expense[date]' => '09/09/1999', 'expense[category]' => 'Stuffed Animals again!', 'expense[amount_in_cents]' => '1000000')));
