= Please note, this library is for the Mavenlink V0 API and is now deprecated. Please visit {developer.mavenlink.com}[http://developer.mavenlink.com] for our current documentation.  We are working on a new PHP library.  At the moment, please use our standard REST API as detailed in the documentation.
...
== Example Usage
    ...
    $mavenlinkApi = new MavenlinkApi(<user_id>, '<api_token>');
...
Try running our examples:
    ...
    1: Edit examples/api_example.php to include your Mavenlink User ID and API Token.
    2: Run
       php examples/api_example.php
       
       or

    1: Edit examples/test.php to include your Mavenlink User ID and API Token.
