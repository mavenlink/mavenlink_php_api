...
The Mavenlink API provides programmatic access to many of Mavenlink's capabilities, including projects, posts, tasks, and time entries.  This is a full-featured PHP Library to the Mavenlink REST API.
...
//Get workspaces
$workspaces_json = $mavenlinkApi->Get_workspaces());
